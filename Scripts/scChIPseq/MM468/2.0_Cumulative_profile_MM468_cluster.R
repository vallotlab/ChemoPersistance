...
cum_C1_K27 <- rtracklayer::import(file.path(inputDir_sc, "MM468_sc_C1_K27me3.bw"))
...
regions = list(
    ...
    c("CDX4","chrX",73445254,73456585),
    c("SRTK39","chr2",168196834,168291178)
)
...
for(i in 1:length(regions)){
    ...
    ## 5FU & DMSO sc K27
    cum_C1_K27_tmp = cum_C1_K27[subjectHits(findOverlaps(roi,cum_C1_K27)),]
    ...
    max1 = round(max(c(cum_C1_K27_tmp$score,cum_C4_K27_tmp$score, cum_C2_K27_tmp$score)),3)
    ...
    plotBedgraph(as.data.frame(cum_C1_K27_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0,max1),
                 addscale = TRUE,
                 ylab="C1",
