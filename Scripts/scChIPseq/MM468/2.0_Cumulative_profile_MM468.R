...
###Load data#########
## 5FU & DMSO1 Single Cell K27
cum_5FU1_D33_K27 <- rtracklayer::import(file.path(inputDir_sc, "MM468_5FU1_day33_H3K27me3.bw"))
cum_DMSO1_D60_K27 <- rtracklayer::import(file.path(inputDir_sc, "MM468_DMSO1_day60_H3K27me3.bw"))

## 5FU & DMSO 6 SingleCell K4  
cum_5FU1_D60_K4 <- rtracklayer::import(file.path(inputDir_sc, "MM468_5FU1_day60_H3K4me3.bw"))
cum_DMSO1_day0_K4 <- rtracklayer::import(file.path(inputDir_sc, "MM468_DMSO1_day0_H3K4me3.bw"))
gc()
...
samples="MM468_5FU1_vs_DMSO1_sc_K27_K4"
...
for(i in 1:length(regions)){
    ...
    ## 5FU & DMSO sc K27
    cum_5FU1_D33_K27_tmp = cum_5FU1_D33_K27[subjectHits(findOverlaps(roi,cum_5FU1_D33_K27)),]
    cum_DMSO1_D60_K27_tmp = cum_DMSO1_D60_K27[subjectHits(findOverlaps(roi,cum_DMSO1_D60_K27)),]
    max1 = round(max(c(cum_5FU1_D33_K27_tmp$score,cum_DMSO1_D60_K27_tmp$score)),3)  + 0.2
    
    
    ## 5FU & DMSO 6 SingleCell K4  
    cum_5FU1_D60_K4_tmp = cum_5FU1_D60_K4[subjectHits(findOverlaps(roi,cum_5FU1_D60_K4)),]
    cum_DMSO1_day0_K4_tmp = cum_DMSO1_day0_K4[subjectHits(findOverlaps(roi,cum_DMSO1_day0_K4)),]
    max3 = round(max(c(cum_5FU1_D60_K4_tmp$score,cum_DMSO1_day0_K4_tmp$score)),3)
    ...
    plotBedgraph(as.data.frame(cum_DMSO1_D60_K27_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0, max1),
                 addscale = TRUE,
                 ylab="sc_DMSO_K27",
                 color="#dfdfdfff",cex.lab=1,cex.main=2.1)
    
    plotBedgraph(as.data.frame(cum_5FU1_D33_K27_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0,max1),
                 addscale = TRUE,
                 ylab="sc_5FU_K27",
    ...
    plotBedgraph(as.data.frame(cum_DMSO1_day0_K4_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0, max3),
                 addscale = TRUE,
                 ylab="sc_DMSO_K4",
    ...
    plotBedgraph(as.data.frame(cum_5FU1_D60_K4_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0,max3),
                 addscale = TRUE,
                 ylab="sc_5FU_K4",
                 color="#1AB8AD",cex.lab=1,cex.main=2.1)
