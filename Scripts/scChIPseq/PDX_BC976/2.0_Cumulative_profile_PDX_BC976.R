...
###Load data#########
HBCx95_UNT_K27 <- rtracklayer::import(file.path(inputDir,"HBCx95_m43_UNT_H3K27me3.bw"))
HBCx95_UNT_K4 <- rtracklayer::import(file.path(inputDir,"HBCx95_m43_UNT_H3K4me3.bw"))
gc()
