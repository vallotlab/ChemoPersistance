...
resultZ_K4 <- read.csv( gzfile(file.path(dataDir_sc,"HBCx95_m43_UNT_H3K4me3_TSS.tsv.gz")),sep="\t")
RZ_K4 <- rowSums(resultZ_K4[,-1])  #RZ matrix is the raw count matrix
RZ_RPKM_K4 <- (10^9*t(t((RZ_K4+1)/10001/sum(RZ_K4))))

resultZ_K27 <- read.csv(gzfile(file.path(dataDir_sc,"HBCx95_m43_UNT_H3K27me3_TSS.tsv.gz")),sep="\t")
