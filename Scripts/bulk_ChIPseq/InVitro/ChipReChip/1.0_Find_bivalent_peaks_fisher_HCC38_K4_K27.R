...
maindir= here()
resdir <- file.path(maindir,"output","bulk_ChIPseq","HCC38","ChIPreChIP")
if(!dir.exists(resdir)) dir.create(resdir)
source(file.path(maindir,"Scripts","global_var.R"))


inputDir =  "/media/pprompsy/Depic_bioinfo_1/InstitutCurie/Documents/Data/results/ChIP_reChIP_D712/HCC38/03subsample_bam/"# file.path(maindir, "input","bulk_ChIPseq","HCC38","ChIPreChIP")
outputDir = file.path(maindir, "output","bulk_ChIPseq","HCC38","ChIPreChIP")

# K27 K4 files
# No primary K4 - K27 !!! Take primary K4 - IgG
primary_K4 = file.path(inputDir,"HCC38_primary_H3K4me3_H3K27me3.subsample.bam")
chipReChip_K4_K27 = file.path(inputDir,"HCC38_reChIP_H3K4me3_H3K27me3.subsample.bam")
...
# K27 IgG files
primary_K4_IgG = file.path(inputDir,"HCC38_primary_H3K4me3_IgG.subsample.bam")
chipReChip_K4_IgG= file.path(inputDir,"HCC38_reChIP_H3K4me3_IgG.subsample.bam")
...
scRNA = readxl::read_xlsx(file.path(maindir,"output","scRNAseq","HCC38","Persister","Supervised","Tables","Differential_analysis_Limma_logFC_1.58.xlsx"))
tab=data.frame()
