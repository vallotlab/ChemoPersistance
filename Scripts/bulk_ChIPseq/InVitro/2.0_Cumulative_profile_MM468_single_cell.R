...
cum_DMSO1_day60_H3K27me3 <- rtracklayer::import(file.path(inputDir_sc, "MM468_DMSO1_day60_H3K27me3.bw"))
cum_5FU1_day33_H3K27me3 <- rtracklayer::import(file.path(inputDir_sc, "MM468_5FU1_day33_H3K27me3.bw"))
cum_5FU6_day131_H3K27me3 <- rtracklayer::import(file.path(inputDir_sc, "MM468_5FU6_day131_H3K27me3.bw"))
cum_5FU3_day147_H3K27me3 <- rtracklayer::import(file.path(inputDir_sc, "MM468_5FU3_day147_H3K27me3.bw"))
cum_5FU2_day171_H3K27me3 <- rtracklayer::import(file.path(inputDir_sc, "MM468_5FU2_day171_H3K27me3.bw"))
...
for(i in 1:length(regions)){
    ...
    ## 5FU & DMSO sc K27
    cum_DMSO1_day60_H3K27me3_tmp = cum_DMSO1_day60_H3K27me3[subjectHits(findOverlaps(roi,cum_DMSO1_day60_H3K27me3)),]
    cum_5FU1_day33_H3K27me3_tmp = cum_5FU1_day33_H3K27me3[subjectHits(findOverlaps(roi,cum_5FU1_day33_H3K27me3)),]
    cum_5FU6_day131_H3K27me3_tmp = cum_5FU6_day131_H3K27me3[subjectHits(findOverlaps(roi,cum_5FU6_day131_H3K27me3)),]
    cum_5FU3_day147_H3K27me3_tmp = cum_5FU3_day147_H3K27me3[subjectHits(findOverlaps(roi,cum_5FU3_day147_H3K27me3)),]
    cum_5FU2_day171_H3K27me3_tmp = cum_5FU2_day171_H3K27me3[subjectHits(findOverlaps(roi,cum_5FU2_day171_H3K27me3)),]
    
    max1 = round(max(c(cum_DMSO1_day60_H3K27me3_tmp$score,cum_5FU1_day33_H3K27me3_tmp$score,
                       cum_5FU6_day131_H3K27me3_tmp$score,cum_5FU3_day147_H3K27me3_tmp$score,
                       cum_5FU2_day171_H3K27me3_tmp$score)),3)
    ...
    plotBedgraph(as.data.frame(cum_DMSO1_day60_H3K27me3_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0, max1),
                 addscale = TRUE,
                 ylab="DMSO1_day60",
                 color=metadata$sample_id_color[1],cex.lab=1,cex.main=2.1)
    
    plotBedgraph(as.data.frame(cum_5FU1_day33_H3K27me3_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0,max1),
                 addscale = TRUE,
                 ylab="5FU1_day33",
                 color=metadata$sample_id_color[4],cex.lab=1,cex.main=2.1)
    
    #sc K4 c("#A6A6A6FF", "#00544CFF")
    plotBedgraph(as.data.frame(cum_5FU6_day131_H3K27me3_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0, max1),
                 addscale = TRUE,
                 ylab="5FU6_day131",
                 color=metadata$sample_id_color[6],cex.lab=1,cex.main=2.1)
    
    plotBedgraph(as.data.frame(cum_5FU3_day147_H3K27me3_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0,max1),
                 addscale = TRUE,
                 ylab="5FU3_day147",
                 color=metadata$sample_id_color[7],cex.lab=1,cex.main=2.1)
    
    par(mar = c(1, 6, 1, 1),xpd=NA)    
    
    plotBedgraph(as.data.frame(cum_5FU2_day171_H3K27me3_tmp)[,c(1,2,3,6)],
                 chrom, chromstart,chromend,
                 range = c(0,max1),
                 addscale = TRUE,
                 ylab="5FU2_day171",
                 color=metadata$sample_id_color[8],cex.lab=1,cex.main=2.1)
