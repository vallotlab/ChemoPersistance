...
cum_C3_C4_K27 <- rtracklayer::import(file.path(inputDir_sc, "MM468_sc_C3_C4_K27me3.bw"))
...
for(i in 1:length(regions)){
    ...
    cum_C3_C4_K27_tmp = cum_C3_C4_K27[subjectHits(findOverlaps(roi,cum_C3_C4_K27)),]
    max1 = round(max(c(cum_C2_K27_tmp$score,cum_C3_C4_K27_tmp$score)),3)
    ...
    plotBedgraph(as.data.frame(cum_C3_C4_K27_tmp)[,c(1,2,3,6)],
