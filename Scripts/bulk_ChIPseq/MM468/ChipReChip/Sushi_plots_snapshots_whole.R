...
inputDir <- file.path(maindir,"input","bulk_ChIPseq","BigWigs","MM468")
...
chiprechip_H3K27me3_H3K4me3 <- rtracklayer::import(file.path(inputDir, "MM468bc_hu_dilution_m10y20_H3K27me3_H3K4me3.bw"))
chiprechip_H3K27me3_IgG <- rtracklayer::import(file.path(inputDir, "MM468bc_hu_dilution_m10y20_H3K27me3_IgG.bw"))

primary_H3K27me3_H3K4me3 <- rtracklayer::import(file.path(inputDir, "MM468bc_hu_dilution_primaryK27_K4_m10y20_H3K27me3.bw"))
primary_H3K27me3_IgG <- rtracklayer::import(file.path(inputDir, "MM468bc_hu_dilution_primaryK27_IgG_m10y20_H3K27me3.bw"))
...
for(i in 1:length(regions)){
    ...
    ## 5FU & DMSO sc K27
    chiprechip_H3K27me3_H3K4me3_tmp = chiprechip_H3K27me3_H3K4me3[subjectHits(findOverlaps(roi,chiprechip_H3K27me3_H3K4me3)),]
    primary_H3K27me3_H3K4me3_tmp = primary_H3K27me3_H3K4me3[subjectHits(findOverlaps(roi,primary_H3K27me3_H3K4me3)),]
    
    max1 = round(max(c(chiprechip_H3K27me3_H3K4me3_tmp$score,primary_H3K27me3_H3K4me3_tmp$score)),3)
    
    chiprechip_H3K27me3_IgG_tmp = chiprechip_H3K27me3_IgG[subjectHits(findOverlaps(roi,chiprechip_H3K27me3_IgG)),]
    primary_H3K27me3_IgG_tmp = primary_H3K27me3_IgG[subjectHits(findOverlaps(roi,primary_H3K27me3_IgG)),]
    
    max2 = round(max(c(primary_H3K27me3_IgG_tmp$score,chiprechip_H3K27me3_IgG_tmp$score)),3)
    max = max(max1,max2)
    if(length(chiprechip_H3K27me3_IgG_tmp) >0 & length(chiprechip_H3K27me3_H3K4me3_tmp) >0){
        ...
        plotBedgraph(as.data.frame(chiprechip_H3K27me3_H3K4me3_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(0, max),
                     addscale = TRUE,
                     ylab="H3K27me3_H3K4me3",
                     color="#009688",cex.lab=1,cex.main=2.1)
        
        
        plotBedgraph(as.data.frame(primary_H3K27me3_H3K4me3_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(0,max),
                     addscale = TRUE,
                     ylab="H3K27me3",
        ...
        plotBedgraph(as.data.frame(chiprechip_H3K27me3_IgG_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(0, max),
                     addscale = TRUE,
                     ylab="H3K27me3_IgG",
        ...
        plotBedgraph(as.data.frame(primary_H3K27me3_IgG_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(0,max),
                     addscale = TRUE,
                     ylab="H3K27me3",
