...
chiprechip_H3K27me3_H3K4me3_vs_primaryK27 <- rtracklayer::import(file.path(inputDir, "chiprechip_H3K27me3_H3K4me3_vs_primaryK27.bw"))
chiprechip_H3K27me3_IgG_vs_primaryK27 <- rtracklayer::import(file.path(inputDir, "chiprechip_H3K27me3_IgG_vs_primaryK27.bw"))
...
for(i in 1:length(regions)){
    ...
    if(length(chiprechip_H3K27me3_IgG_vs_primaryK27_tmp) >0 & length(chiprechip_H3K27me3_H3K4me3_vs_primaryK27_tmp) >0){
        ...
        layout.matrix <- matrix(c(1,1,1,2,2,2,3,3,4), ncol = 1)
