...
inputDir_bulk <- file.path(maindir,"input","scChIPseq","MM468","BigWigs")
...
cum_5FU_D33_K27_CI <- rtracklayer::import(file.path(inputDir_bulk, "MM468_5FU_D33_K27_F02.bw"))
cum_DMSO_D33_K27_CI <- rtracklayer::import(file.path(inputDir_bulk, "MM468_DMSO_D33_K27_E02.bw"))

## 5FU & DMSO Bulk K27
cum_GSKJ4_D33_K27_CI <- rtracklayer::import(file.path(inputDir_bulk, "MM468_GSKJ4_D33_K27_D02.bw"))
cum_UNC_D33_K27_CI <- rtracklayer::import(file.path(inputDir_bulk, "MM468_UNC_D33_K27_A02.bw"))
cum_UNC_5FU_D33_K27_CI <- rtracklayer::import(file.path(inputDir_bulk, "MM468_UNC_5FU_D33_K27_C02.bw"))
