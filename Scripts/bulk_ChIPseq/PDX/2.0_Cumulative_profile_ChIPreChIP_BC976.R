...
inputDir_coverage <- file.path(maindir,"input","bulk_ChIPseq","PDX", "ChIPreChIP","BigWigs")
...
reChIP_K4me3_IgG <- rtracklayer::import(file.path(inputDir_coverage, "PDX_BC976_reChIP_K4me3_IgG.bw"))
primary_K4me3_IgG <- rtracklayer::import(file.path(inputDir_coverage, "PDX_BC976_primary_K4me3_IgG.bw"))

reChIP_K4me3_K27me3 <- rtracklayer::import(file.path(inputDir_coverage, "PDX_BC976_reChIP_K4me3_K27me3.bw"))
primary_K4me3_K27me3 <- rtracklayer::import(file.path(inputDir_coverage, "PDX_BC976_primary_K4me3_K27me3.bw"))
gc()
...
samples="ChIPreChIP_compare_PDX_BC976"
...
for(i in 1:length(regions)){
    ...
    reChIP_K4me3_IgG_tmp = reChIP_K4me3_IgG[subjectHits(findOverlaps(roi, reChIP_K4me3_IgG)),]
    primary_K4me3_IgG_tmp = primary_K4me3_IgG[subjectHits(findOverlaps(roi, primary_K4me3_IgG)),]
    
    reChIP_K4me3_K27me3_tmp = reChIP_K4me3_K27me3[subjectHits(findOverlaps(roi, reChIP_K4me3_K27me3)),]
    primary_K4me3_K27me3_tmp = primary_K4me3_K27me3[subjectHits(findOverlaps(roi, primary_K4me3_K27me3)),]
    
    ## Chip rechip
    if(length(reChIP_K4me3_K27me3_tmp) ==0 ) reChIP_K4me3_K27me3_tmp = roi
    if(length(primary_K4me3_K27me3_tmp) ==0 ) primary_K4me3_K27me3_tmp = roi
    if(length(reChIP_K4me3_IgG_tmp) ==0 ) reChIP_K4me3_IgG_tmp = roi
    if(length(primary_K4me3_IgG_tmp) ==0 ) primary_K4me3_IgG_tmp = roi
    
    max = round(max(c(reChIP_K4me3_K27me3_tmp$score,primary_K4me3_K27me3_tmp$score,
                      reChIP_K4me3_IgG_tmp$score,primary_K4me3_IgG_tmp$score)),3) + 0.001
    min = round(min(c(reChIP_K4me3_K27me3_tmp$score,primary_K4me3_K27me3_tmp$score,
                      reChIP_K4me3_IgG_tmp$score,primary_K4me3_IgG_tmp$score)),3) - 0.001
    
    if(min > 0) min = 0
    
    if( (length(primary_K4me3_K27me3_tmp) !=0 | length(reChIP_K4me3_K27me3_tmp) !=0) &
        (length(primary_K4me3_IgG_tmp) !=0 | length(reChIP_K4me3_IgG_tmp) !=0)){
        ...
        plotBedgraph(as.data.frame(primary_K4me3_K27me3_tmp)[,c(1,2,3,6)],
        ...
        plotBedgraph(as.data.frame(reChIP_K4me3_K27me3_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(min,max),
                     addscale = TRUE,
                     ylab="2nd H3K4me3-H3K27me3",
                     color="#afafafff",cex.lab=1,cex.main=2.1)
        
        plotBedgraph(as.data.frame(primary_K4me3_IgG_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(min, max),
                     addscale = TRUE,
                     ylab="1st H3K4me3",
        ...
        plotBedgraph(as.data.frame(reChIP_K4me3_IgG_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(min,max),
                     addscale = TRUE,
                     ylab="2nd H3K4me3-IgG",
                     color="#afafafff",cex.lab=1,cex.main=2.1)
