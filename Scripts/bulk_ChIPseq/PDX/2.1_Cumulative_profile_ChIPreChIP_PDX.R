...
inputDir_compare <- file.path(maindir,"input","bulk_ChIPseq","PDX", "ChIPreChIP","BigWigs_Compare")
resDir <- file.path(maindir,"output","bulk_ChIPseq","Snapshots")
load(file.path(maindir,"annotation","Gencode_hg38_v25.RData"))

print(list.files(inputDir_coverage))
print(list.files(inputDir_compare))

###Load data#########
library(rtracklayer)
## 5FU & DMSO6 Single Cell K27
chiprechip_K4_PDX_BC408 <- rtracklayer::import.bw(file.path(inputDir_compare, "BC408_reChIP_H3K4me3_H3K27me3_vs_primary_H3K4me3.bw"))
chiprechip_IgG_PDX_BC408 <- rtracklayer::import(file.path(inputDir_compare, "BC408_reChIP_H3K4me3_IgG_vs_primary_H3K4me3.bw"))

chiprechip_K4_PDX_BC1224 <- rtracklayer::import(file.path(inputDir_compare, "BC1224_reChIP_H3K4me3_H3K27me3_vs_primary_H3K4me3.bw"))
chiprechip_IgG_PDX_BC1224 <- rtracklayer::import(file.path(inputDir_compare, "BC1224_reChIP_H3K4me3_IgG_vs_primary_H3K4me3.bw"))

chiprechip_K4_PDX_BC976 <- rtracklayer::import(file.path(inputDir_compare, "BC976_reChIP_H3K4me3_H3K27me3_vs_primary_H3K4me3.bw"))
chiprechip_IgG_PDX_BC976 <- rtracklayer::import(file.path(inputDir_compare, "BC976_reChIP_H3K4me3_IgG_vs_primary_H3K4me3.bw"))
gc()
...
samples="ChIPreChIP_compare_PDX_latest"
...
for(i in 1:length(regions)){
    ...
    ## Chip rechip
    chiprechip_K4_PDX_BC976_tmp = chiprechip_K4_PDX_BC976[subjectHits(findOverlaps(roi,chiprechip_K4_PDX_BC976)),]
    chiprechip_IgG_PDX_BC976_tmp = chiprechip_IgG_PDX_BC976[subjectHits(findOverlaps(roi,chiprechip_IgG_PDX_BC976)),]
    
    chiprechip_K4_PDX_BC408_tmp = chiprechip_K4_PDX_BC408[subjectHits(findOverlaps(roi,chiprechip_K4_PDX_BC408)),]
    chiprechip_IgG_PDX_BC408_tmp = chiprechip_IgG_PDX_BC408[subjectHits(findOverlaps(roi,chiprechip_IgG_PDX_BC408)),]
    
    chiprechip_K4_PDX_BC1224_tmp = chiprechip_K4_PDX_BC1224[subjectHits(findOverlaps(roi,chiprechip_K4_PDX_BC1224)),]
    chiprechip_IgG_PDX_BC1224_tmp = chiprechip_IgG_PDX_BC1224[subjectHits(findOverlaps(roi,chiprechip_IgG_PDX_BC1224)),]
    
    if(length(chiprechip_K4_PDX_BC976_tmp) ==0 ) chiprechip_K4_PDX_BC976_tmp = roi
    if(length(chiprechip_IgG_PDX_BC976_tmp) ==0 ) chiprechip_IgG_PDX_BC976_tmp = roi
    if(length(chiprechip_K4_PDX_BC408_tmp) ==0 ) chiprechip_K4_PDX_BC408_tmp = roi
    if(length(chiprechip_IgG_PDX_BC408_tmp) ==0 ) chiprechip_IgG_PDX_BC408_tmp = roi
    if(length(chiprechip_K4_PDX_BC1224_tmp) ==0 ) chiprechip_K4_PDX_BC1224_tmp = roi
    if(length(chiprechip_IgG_PDX_BC1224_tmp) ==0 ) chiprechip_IgG_PDX_BC1224_tmp = roi
    
    max1 = round(max(c(chiprechip_K4_PDX_BC976_tmp$score,chiprechip_IgG_PDX_BC976_tmp$score)),3) + 0.001
    min1 = round(min(c(chiprechip_K4_PDX_BC976_tmp$score,chiprechip_IgG_PDX_BC976_tmp$score)),3) - 0.001
    max2 = round(max(c(chiprechip_K4_PDX_BC408_tmp$score,chiprechip_IgG_PDX_BC408_tmp$score)),3) + 0.001
    min2 = round(min(c(chiprechip_K4_PDX_BC408_tmp$score,chiprechip_IgG_PDX_BC408_tmp$score)),3) - 0.001
    max3 = round(max(c(chiprechip_K4_PDX_BC1224_tmp$score,chiprechip_IgG_PDX_BC1224_tmp$score)),3) + 0.001
    min3 = round(min(c(chiprechip_K4_PDX_BC1224_tmp$score,chiprechip_IgG_PDX_BC1224_tmp$score)),3) - 0.001

    if( (length(chiprechip_IgG_PDX_BC976_tmp) !=0 | length(chiprechip_K4_PDX_BC976_tmp) !=0) &
        (length(chiprechip_IgG_PDX_BC408_tmp) !=0 | length(chiprechip_K4_PDX_BC408_tmp) !=0) &
        (length(chiprechip_K4_PDX_BC1224_tmp) !=0 | length(chiprechip_IgG_PDX_BC1224_tmp) !=0)){
        ...
        plotBedgraph(as.data.frame(chiprechip_K4_PDX_BC976_tmp)[,c(1,2,3,6)],
        ...
        plotBedgraph(as.data.frame(chiprechip_IgG_PDX_BC976_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(min1,max1),
                     addscale = TRUE,
                     ylab="BC976\nH3K4me3_IgG",
        ...
        plotBedgraph(as.data.frame(chiprechip_K4_PDX_BC408_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(min2, max2),
                     addscale = TRUE,
                     ylab="BC408\nH3K4me3_H3K27me3",
        ...
        plotBedgraph(as.data.frame(chiprechip_IgG_PDX_BC408_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(min2,max2),
                     addscale = TRUE,
                     ylab="BC408\nH3K4me3_IgG",
        ...
        plotBedgraph(as.data.frame(chiprechip_K4_PDX_BC1224_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(min3, max3),
                     addscale = TRUE,
                     ylab="BC1224\nH3K4me3_H3K27me3",
        ...
        plotBedgraph(as.data.frame(chiprechip_IgG_PDX_BC1224_tmp)[,c(1,2,3,6)],
                     chrom, chromstart,chromend,
                     range = c(min3,max3),
                     addscale = TRUE,
                     ylab="BC1224\nH3K4me3_IgG",
