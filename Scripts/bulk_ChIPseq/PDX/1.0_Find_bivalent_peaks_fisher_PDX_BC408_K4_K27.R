...
maindir= here()
resdir <- file.path(maindir,"output","bulk_ChIPseq","BC408","ChIPreChIP")
if(!dir.exists(resdir)) dir.create(resdir)
source(file.path(maindir,"Scripts","global_var.R"))


inputDir =  "/media/pacome/Depic_bioinfo_1/InstitutCurie/Documents/Data/results/ChIP_reChIP_D767/PDX/03dedup_bam//"# file.path(maindir, "input","bulk_ChIPseq","BC408","ChIPreChIP")
outputDir = file.path(maindir, "output","bulk_ChIPseq","BC408","ChIPreChIP")
library(here)

# K27 K4 files
primary_K4 = file.path(inputDir,"BC408_primary_H3K4me3_H3K27me3.hg38.subsample.bam")
chipReChip_K4_K27 = file.path(inputDir,"BC408_reChIP_H3K4me3_H3K27me3.hg38.subsample.bam")
summits_K4_K27_primary = rtracklayer::import(file.path(maindir, "input","bulk_ChIPseq","PDX","ChIPreChIP","Peaks","BC408_primary_H3K4me3_H3K27me3_summits_merged_filtered_by_TSS.bed"))
summits_K4_K27_primary = unique(summits_K4_K27_primary)

# K27 IgG files
primary_K4_IgG = file.path(inputDir,"BC408_primary_H3K4me3_IgG.hg38.subsample.bam")
chipReChip_K4_IgG= file.path(inputDir,"BC408_reChIP_H3K4me3_IgG.hg38.subsample.bam")
summits_K4_IgG_primary = rtracklayer::import(file.path(maindir, "input","bulk_ChIPseq","PDX","ChIPreChIP","Peaks","BC408_primary_H3K4me3_IgG_summits_merged_filtered_by_TSS.bed"))
