...
maindir= here()
inputDir <- file.path(maindir,"input","scChIPseq","BigWigs","PDX")
...
###Load data#########
HBCx95_UNT_K27 <- rtracklayer::import(file.path(inputDir,"HBCx95_UNT_K27.bw"))
HBCx95_UNT_K4 <- rtracklayer::import(file.path(inputDir,"HBCx95_UNT_K4.bw"))
gc()
