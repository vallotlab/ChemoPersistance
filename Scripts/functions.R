violin_plot_cooccurence <- function(
    ...
    coocurrence_persister_genes_score[sub_cells[[2]],"sample"] = levels[2]
    ...
    ggplot(coocurrence_persister_genes_score, aes(x=sample,y=coocurrence_score,
        ...
        ggpubr::stat_compare_means(method = "t.test",ref.group = levels[1])
