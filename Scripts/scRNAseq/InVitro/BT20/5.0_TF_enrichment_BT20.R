...
# Directories -------------------------------------------------------------
maindir= here()
resdir <- file.path(maindir,"output","scRNAseq","BT20","Persister")
...
rowSums(BinCounts)
persister_DA = readxl::read_xlsx(file.path(maindir,"output","scRNAseq","BT20","Persister","Supervised",
...
other_genes = readxl::read_xlsx(file.path(maindir,"output","scRNAseq","BT20","Persister","Supervised",
