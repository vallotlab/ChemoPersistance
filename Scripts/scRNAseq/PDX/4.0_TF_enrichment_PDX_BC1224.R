...
color_BC1224 <- c(control[c(1)],persister_color[c(3)])

samples_BC1224 = c("BC1224_chemonaive","BC1224_persister")
corres <- data.frame(BC1224=samples_BC1224,color=color_BC1224)
...
rowSums(BinCounts)
persister_DA = readxl::read_xlsx(file.path(maindir,"output","scRNAseq","PDX_BC1224","Supervised",
...
DA = readxl::read_xlsx(file.path(maindir,"output","scRNAseq","PDX_BC1224","Supervised",
...
persister_genes_homogeneous = persister_DA$Symbol[which(persister_DA$percent_expressed > 0.25)]
